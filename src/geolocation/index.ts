 ...
 * @internal 
 */
function updateGeolocationState(state: InputsState, coords: GeolocationCoordinates) {
 ...
 * @internal
 */
function updateGeolocationStatus(state: InputsState, accuracy: number | null) {
 ...
 */
export function initInputGeolocation(state: InputsState, options: GeolocationOptions = {}) {
...
export function isGeolocationKey(keyId: KeyId): boolean {
