...
import {
    KeyBackspace, KeyTab, KeyEnter, KeyShift, KeyCtrl, KeyAlt, KeyPauseBreak, KeyCapsLock, KeyEscape, KeySpace,
    KeyPageUp, KeyPageDown, KeyEnd, KeyHome, KeyArrowLeft, KeyArrowUp, KeyArrowRight, KeyArrowDown, KeyInsert, KeyDelete,
    Key0, Key1, Key2, Key3, Key4, Key5, Key6, Key7, Key8, Key9,
    KeyA, KeyB, KeyC, KeyD, KeyE, KeyF, KeyG, KeyH, KeyI, KeyJ, KeyK, KeyL, KeyM, KeyN, KeyO, KeyP, KeyQ, KeyR, KeyS, KeyT, KeyU, KeyV, KeyW, KeyX, KeyY, KeyZ,
    KeyMeta, KeyContextMenu,
    KeyNumpad0, KeyNumpad1, KeyNumpad2, KeyNumpad3, KeyNumpad4, KeyNumpad5, KeyNumpad6, KeyNumpad7, KeyNumpad8, KeyNumpad9,
    KeyNumpadMultiply, KeyNumpadAdd, KeyNumpadSubtract, KeyNumpadDecimal, KeyNumpadDivide,
    KeyF1, KeyF2, KeyF3, KeyF4, KeyF5, KeyF6, KeyF7, KeyF8, KeyF9, KeyF10, KeyF11, KeyF12,
    KeyNumLock, KeyScrollLock,
    KeySemicolon, KeyEqual, KeyComma, KeyDash, KeyPeriod, KeyForwardSlash, KeyGraveAccent, KeyOpenBracket, KeyBackslash, KeyCloseBracket, KeySingleQuote
} from './keys';
 ...
 */
export const keyMap: { readonly [code: string]: KeyId } = {
 ...
 */
export const keyboardKeyMap: { readonly [keyId: KeyId]: string } = {
